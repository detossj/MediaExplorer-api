...
fun LoginScreen(
    ...
    Column(
        ...
        Text(text = "Member login", style = MaterialTheme.typography.headlineMedium)
        ...
        when (authState) {
            ...
            is AuthUiState.Success -> Text("Authentication successful!", color = MaterialTheme.colorScheme.primary)
